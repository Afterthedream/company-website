      ...
      <section className="py-28 bg-surface-50 dark:bg-surface-950">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="flex justify-center mb-14">
            <div className="inline-flex bg-surface-100 dark:bg-surface-800 rounded-xl p-1" role="tablist" aria-label="新闻分类">
          ...
          {loading ? (
            ...
            <div id="news-tab-panel" role="tabpanel" className="text-center py-20">
              ...
              <h3 className="text-lg font-semibold text-surface-700 dark:text-surface-300 mb-2">暂时还没有新闻哦</h3>
              ...
              <div ref={gridRef} className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
                {visibleArticles.map((item: any, index: number) => {
                  ...
                  return (
                    ...
                    >
                      <div className="card-surface dark:card-surface-dark overflow-hidden card-hover h-full">
                        <div className="aspect-[16/10] bg-surface-50 dark:bg-surface-900 overflow-hidden">
                          {imgUrl ? (
                            <img
                              src={imgUrl}
                              alt={item.title}
                        ...
                        <div className="p-5 space-y-3">
                          ...
                          <h3 className="text-[15px] font-semibold text-surface-900 dark:text-surface-100 leading-snug line-clamp-2 group-hover:text-primary-700 dark:group-hover:text-primary-400 transition-colors duration-200">
                            {item.title}
                          </h3>
