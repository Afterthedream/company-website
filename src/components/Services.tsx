...
export default function Services({ products = [] }: ServicesProps) {
  ...
  return (
    <section ref={sectionRef} className="py-28 bg-surface-50 dark:bg-surface-950 relative overflow-hidden">
      {/* 背景光晕（带色调，不是纯黑） */}
      <div className="absolute top-0 left-1/4 w-[600px] h-[600px] bg-primary-900/30 dark:bg-primary-900/30 rounded-full blur-3xl" />
      <div className="absolute bottom-0 right-1/4 w-[400px] h-[400px] bg-primary-800/20 dark:bg-primary-800/20 rounded-full blur-3xl" />
