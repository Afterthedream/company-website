...
export default function Hero({ company }: HeroProps) {
  ...
  return (
    <section className="relative min-h-[100vh] flex items-center overflow-hidden">
      {/* 背景：偏冷调的浅色 */}
      <div className="absolute inset-0 bg-gradient-to-br from-surface-50 via-white to-primary-50/40 dark:from-surface-950 dark:via-surface-900 dark:to-primary-950/40" />
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 lg:px-8 w-full">
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            >
              <h2 className="text-xl md:text-2xl font-bold text-primary-700 dark:text-primary-500 mb-2">
                四川沧杰荇科技有限公司
              </h2>
            ...
            {/* 主标题 - 清晰说明业务 */}
            <div
              className={`space-y-4 transition-all duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] delay-100 ${
                isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'
              }`}
            >
              <h1 className="font-display text-2xl sm:text-3xl md:text-4xl font-extrabold leading-[1.2] tracking-tight text-surface-900 dark:text-surface-100">
                一站式水利信息化问题解决者
              </h1>
              <p className="text-lg md:text-xl text-surface-700 dark:text-surface-300 leading-relaxed max-w-2xl">
                专注于水利工程智能化、水环境监测、智慧水务系统开发，提供从硬件设备到软件平台的一站式服务
              </p>
            </div>

            {/* 核心业务标签 - 直观展示 */}
            <div
              className={`flex flex-wrap gap-3 pt-2 transition-all duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] delay-150 ${
                isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
              }`}
            >
              <span className="inline-flex items-center px-4 py-2 bg-primary-50 border border-primary-200 dark:bg-primary-950 dark:border-primary-900 rounded-lg text-sm font-medium text-primary-700 dark:text-primary-500">
                  <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  智能监测设备
                </span>
                <span className="inline-flex items-center px-4 py-2 bg-accent-50 border border-accent-200 dark:bg-accent-950 dark:border-accent-900 rounded-lg text-sm font-medium text-accent-700 dark:text-accent-500">
                  <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  数据管理平台
            ...
            {/* 按钮组 */}
            <div
              className={`flex flex-col sm:flex-row gap-4 pt-4 transition-all duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] delay-200 ${
                isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
              }`}
            >
          ...
          >
            <div className="relative w-full max-w-[380px] aspect-square">
              {/* 底层渐变圆 */}
              <div className="absolute inset-8 rounded-full bg-gradient-to-br from-primary-100/60 via-accent-50/40 to-primary-50/60 dark:from-primary-900/30 dark:via-accent-900/20 dark:to-primary-900/30 animate-breathe" />
