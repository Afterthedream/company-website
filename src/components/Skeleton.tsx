...
function SkeletonBase({ className = '', shimmer = false }: SkeletonProps) {
  return (
    <div
      className={`rounded-lg ${shimmer ? 'skeleton-shimmer' : 'animate-pulse bg-surface-200 dark:bg-surface-700'} ${className}`}
    />
  )
}
...
export function SolutionCardSkeleton({ delay = 0 }: { delay?: number }) {
  return (
    <div
      className="bg-white dark:bg-surface-900 rounded-2xl border border-surface-200 dark:border-surface-800 shadow-lg p-8 md:p-10"
...
export function ServiceCardSkeleton() {
  return (
    <div className="h-full p-8 rounded-2xl bg-white/[0.06] dark:bg-surface-900/[0.06] border border-white/[0.08] dark:border-surface-700/[0.08]">
      <div className="flex items-center justify-between mb-7">
        <SkeletonBase className="w-14 h-14 rounded-2xl bg-surface-700/20 dark:bg-surface-300/20" />
        <SkeletonBase className="w-2 h-2 rounded-full bg-surface-700/20 dark:bg-surface-300/20" />
      </div>
      <SkeletonBase className="h-6 w-32 rounded mb-3 bg-surface-700/20 dark:bg-surface-300/20" />
      <SkeletonBase className="h-4 w-full rounded mb-2 bg-surface-700/20 dark:bg-surface-300/20" />
      <SkeletonBase className="h-4 w-3/4 rounded mb-6 bg-surface-700/20 dark:bg-surface-300/20" />
      <SkeletonBase className="h-4 w-20 rounded bg-surface-700/20 dark:bg-surface-300/20" />
    </div>
  )
}
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-5">
            {Array.from({ length: 3 }).map((_, i) => (
              <div key={i} className="card-surface dark:card-surface-dark p-8">
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              {Array.from({ length: 3 }).map((_, i) => (
                <div key={i} className="flex items-start gap-4 p-5 rounded-xl bg-surface-50 dark:bg-surface-900">
